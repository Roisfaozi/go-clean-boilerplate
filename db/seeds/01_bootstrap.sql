...
('role-admin-id', 'role:superadmin', 'Super Administrator with full access', UNIX_TIMESTAMP()*1000, UNIX_TIMESTAMP()*1000),
...
('admin-user-id', 'superadmin', 'superadmin@example.com', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 'Super Admin', UNIX_TIMESTAMP()*1000, UNIX_TIMESTAMP()*1000, '');

-- Assign role:admin to admin user
INSERT INTO casbin_rule (ptype, v0, v1) VALUES 
('g', 'admin-user-id', 'role:superadmin');
