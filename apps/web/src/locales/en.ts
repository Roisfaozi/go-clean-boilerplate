export default {
  ...
  features: {
    ...
    libs: {
      nextjs: "App dir, Routing, Layouts, API routes, Server Components, Server actions.",
      ...
      internationalization: "Internationalization support with type-safe Next-International.",
