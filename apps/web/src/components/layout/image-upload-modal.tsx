    ...
    <Dialog open={open} onOpenChange={(val) => {
      ...
      <DialogTrigger asChild>
        <Button 
          ...
          variant="outline" 
          size="icon" 
          className="absolute bottom-0 right-0 h-8 w-8 rounded-full bg-background/80 text-muted-foreground backdrop-blur-sm hover:bg-background hover:text-foreground shadow-sm"
        >
      ...
      <DialogContent className="sm:max-w-md">
        ...
        <div className="flex flex-col items-center justify-center gap-4 py-4">
          {preview ? (
            ...
            <div className="flex h-40 w-40 flex-col items-center justify-center rounded-full border-4 border-dashed border-muted bg-muted/30 text-muted-foreground">
          ...
          <div className="w-full space-y-2">
            <Label htmlFor="picture-upload" className="sr-only">Choose file</Label>
            <Input 
              id="picture-upload" 
              type="file" 
              accept="image/*" 
