    ...
    <div className="flex flex-col gap-4 md:col-span-2">
      ...
      <div className="grid gap-3">
        <Link href="/dashboard/users" className="block w-full">
          <Button className="h-auto w-full justify-start py-4" variant="outline">
            <div className="flex items-center gap-3">
              ...
              <div className="text-left">
                ...
                <div className="text-muted-foreground text-xs">Add or edit accounts</div>
              </div>
            </div>
          </Button>
        </Link>
          ...
          <Button className="h-auto w-full justify-start py-4" variant="outline">
            <div className="flex items-center gap-3">
              ...
              <div className="text-left">
                ...
                <div className="text-muted-foreground text-xs">Update permissions</div>
              </div>
            </div>
          </Button>
        </Link>
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div className="text-left">
              ...
              <div className="text-muted-foreground text-xs">Download audit trail</div>
            </div>
          </div>
        </Button>
      </div>
