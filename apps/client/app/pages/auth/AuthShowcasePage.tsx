...
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from "@casbin/ui";
...
const loginVariants: Variant[] = [
  ...
  },
  {
    ...
    description: "Full-screen dark theme dengan grid pattern, neon glow, testimonial, dan stats.",
...
const forgotVariants: Variant[] = [
  ...
  },
  {
    id: "fv2",
    title: "Glassmorphism Card",
    description: "Forgot password card dengan glassmorphism di atas rotating gradient background.",
    tags: ["Centered Card", "Glassmorphism", "Gradient BG"],
  ...
  },
  {
    id: "fv3",
    title: "Dark Immersive",
    description: "Dark mode forgot password dengan grid pattern dan neon glow effect.",
    tags: ["Dark Theme", "Grid Pattern", "Neon Glow"],
...
const resetVariants: Variant[] = [
  ...
  },
  {
    id: "rpv3",
    title: "Dark Immersive",
    description: "Dark mode reset password dengan grid pattern, strength pills, dan neon glow.",
