...
const mockData: Permission[] = [
  ...
  },
  {
    ...
    granted: true,
    role_name: "Admin",
    access_right_name: "Delete Users",
  ...
  },
  {
    ...
    granted: true,
    role_name: "Viewer",
    access_right_name: "Read Projects",
...
const fields: FieldDef[] = [
  ...
  },
  {
    ...
    required: true,
    options: [
      { label: "Read Users", value: "1" },
      { label: "Write Users", value: "2" },
      { label: "Delete Users", value: "3" },
      { label: "Read Projects", value: "4" },
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        actions={
          <NexusButton onClick={() => setCreateOpen(true)}>
            <Plus className="h-4 w-4" /> Assign Permission
          </NexusButton>
        }
      />
      ...
      <CrudFormDialog
        ...
        description="Grant or deny an access right to a role."
        fields={fields}
        schema={schema}
        onSubmit={async (v) => {
      ...
      <CrudFormDialog
        ...
        description="Update permission assignment."
        fields={fields}
        schema={schema}
        initialValues={editItem || undefined}
        onSubmit={async (v) => {
          if (editItem) {
            await updatePermission.mutateAsync({ id: editItem.id, data: v as any });
            setEditItem(null);
          }
        }}
