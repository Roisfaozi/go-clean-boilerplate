...
func CORSMiddleware(allowedOrigins []string) gin.HandlerFunc {
	...
	config := cors.Config{
		...
		AllowHeaders:     []string{"Origin", "Content-Type", "Accept", "Authorization", "X-Requested-With", "X-Organization-ID", "X-Organization-Slug", "X-CSRF-Token", "Tus-Resumable", "Upload-Length", "Upload-Metadata", "Upload-Offset", "Upload-Protocol", "Upload-Draft-Interop-Version"},
