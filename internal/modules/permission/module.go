...
func NewUserModule(enforcer *casbin.Enforcer, validate *validator.Validate, log *logrus.Logger) *PermissionModule {

	permissionUseCase := usecase.NewPermissionUseCase(enforcer, log)
