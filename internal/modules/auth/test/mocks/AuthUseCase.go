...
func (_m *AuthUseCase) GenerateAccessToken(user *entity.User) (string, error) {
	ret := _m.Called(user)
...
func (_m *AuthUseCase) GenerateRefreshToken(user *entity.User) (string, error) {
	ret := _m.Called(user)
...
func (_m *AuthUseCase) GetUserSessions(ctx context.Context, userID string) ([]*model.Auth, error) {
...
func (_m *AuthUseCase) Login(ctx context.Context, request model.LoginRequest) (*model.LoginResponse, string, error) {
...
func (_m *AuthUseCase) RefreshToken(ctx context.Context, refreshToken string) (*model.TokenResponse, string, error) {
...
func (_m *AuthUseCase) RevokeAllSessions(ctx context.Context, userID string) error {
	ret := _m.Called(ctx, userID)
...
func (_m *AuthUseCase) RevokeToken(ctx context.Context, userID string, sessionID string) error {
...
func (_m *AuthUseCase) ValidateAccessToken(token string) (*usecase.Claims, error) {
	ret := _m.Called(token)
...
func (_m *AuthUseCase) ValidateRefreshToken(token string) (*usecase.Claims, error) {
	ret := _m.Called(token)
...
func (_m *AuthUseCase) Verify(ctx context.Context, userID string, sessionID string) (*model.Auth, error) {
	ret := _m.Called(ctx, userID, sessionID)
