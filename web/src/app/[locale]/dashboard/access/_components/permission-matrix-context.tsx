...
interface PermissionMatrixContextType {
  ...
  updatePermissions: (roleName: string, resourceName: string, newCrud: ResourceCRUD, oldCrud: ResourceCRUD) => Promise<void>;
...
export function PermissionMatrixProvider({ children }: { children: ReactNode }) {
  ...
  const [dialog, setDialog] = useState({
    ...
    resource: "",
    role: "",
    crud: { create: false, read: false, update: false, delete: false } as ResourceCRUD,
  });
