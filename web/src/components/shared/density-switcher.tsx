        ...
        <TooltipTrigger asChild>
          ...
          >
            <div className="relative">
              ...
              <Box
                className={cn(
                  "h-5 w-5 transition-all absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2",
                  density === "compact" ? "scale-0 rotate-90 opacity-0" : "scale-100 rotate-0 opacity-100"
                )}
              />
              <Layers
                className={cn(
                  "h-5 w-5 transition-all absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2",
                  density === "comfort" ? "scale-0 -rotate-90 opacity-0" : "scale-100 rotate-0 opacity-100"
                )}
              />
            </div>
